...
import CellTypeCreateDialog from './CellTypeCreateDialog'
...
const CellTypeGridList = enhance((props) => {
    const {
        filter,
        createDialog,
        updateDialog,
    ...
    return (
        <Container>
            <div className={classes.wrapper}>
                <SettingSideMenu currentUrl={ROUTES.CELL_TYPE_LIST_URL}/>
...
export default CellTypeGridList
