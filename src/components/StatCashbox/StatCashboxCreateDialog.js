...
const statCashboxCreateDialog = enhance((props) => {
...
statCashboxCreateDialog.propTypes = {
    open: PropTypes.bool.isRequired,
    onClose: PropTypes.func.isRequired,
    loading: PropTypes.bool.isRequired
}

statCashboxCreateDialog.defaultProps = {
    isUpdate: false
}

export default statCashboxCreateDialog
