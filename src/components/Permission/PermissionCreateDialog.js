...
export const PERMISSION_CREATE_DIALOG_OPEN = 'openCreateDialog'
...
const PermissionCreateDialog = enhance((props) => {
...
PermissionCreateDialog.propTypes = {
...
PermissionCreateDialog.defaultProps = {
    isUpdate: false
}
