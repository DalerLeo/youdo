...
const ResumeCreateDialog = enhance((props) => {
  ...
  const stepButtons = [
    ...
    {label: 'Опыт работы', icon: 'experience'},
    {label: 'Образование', icon: 'education'},
    {label: 'Навыки и умения', icon: 'skills'},
    {label: 'Профессиональные ожидания', icon: 'expectations'}
  ]
  ...
  return (
    <Dialog
      ...
      <div className={classes.titleContent}>
        <span>{isUpdate ? 'Изменение анкеты' : 'Создание анкеты'}</span>
