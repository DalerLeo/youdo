...
export const DIVISION_CREATE_DIALOG_OPEN = 'openCreateDialog'
...
const DivisionCreateDialog = enhance((props) => {
    ...
    return (
        <Dialog
            ...
            <div className={classes.titleContent}>
                <span>{isUpdate ? t('Изменить организацию') : t('Добавить организацию')}</span>
...
DivisionCreateDialog.propTypes = {
...
DivisionCreateDialog.defaultProps = {
    isUpdate: false
}

export default DivisionCreateDialog
