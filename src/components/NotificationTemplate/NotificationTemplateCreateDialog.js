...
export const NOTIFICATION_CREATE_DIALOG_OPEN = 'openCreateDialog'
...
const enhance = compose(
    ...
    reduxForm({
        form: 'NotificationTemplateUpdateDialog',
        enableReinitialize: true
    })
)

const NotificationCreateDialog = enhance((props) => {
...
NotificationCreateDialog.propTypes = {
...
NotificationCreateDialog.defaultProps = {
    isUpdate: false
}
