...
export const SYSTEM_PAGES_CREATE_DIALOG_OPEN = 'openCreateDialog'
export const SYSTEM_PAGES_UPDATE_DIALOG_OPEN = 'openUpdateDialog'
...
SystemPagesCreateDialog.propTypes = {
...
SystemPagesCreateDialog.defaultProps = {
    isUpdate: false
}

export default SystemPagesCreateDialog
