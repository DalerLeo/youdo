...
export const PLAN_CREATE_DIALOG_OPEN = 'openCreateDialog'
    ...
    <Dialog
      ...
      <div className={classes.bodyContent}>
        <form onSubmit={onSubmit} className={classes.form}>
          ...
          <div className={classes.inContent} style={{minHeight: '260px', padding: '5px 30px'}}>
