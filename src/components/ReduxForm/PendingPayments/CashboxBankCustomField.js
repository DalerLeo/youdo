...
const getOptions = (search) => {
    return axios().get(`${PATH.CASHBOX_LIST}?search=${search || ''}&page_size=100`, {'params': {'type': 'bank'}})
        .then(({data}) => {
...
const CashboxBankCustomField = (props) => {
    return (
        <SearchField
            getValue={(value) => {
...
export default CashboxBankCustomField
