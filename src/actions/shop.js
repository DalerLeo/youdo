...
export const shopCreateAction = (formValues, location, newClient) => {
    const requestData = serializers.createSerializer(formValues, location, newClient)
    const payload = axios()
...
export const shopUpdateAction = (id, formValues, location, detail) => {
    const requestData = serializers.updateSerializer(formValues, location, detail)
    const payload = axios()
