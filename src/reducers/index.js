...
const rootReducer = combineReducers({
    ...
    shipment: combineReducers({
        ...
        inventory: createThunkReducer(actionTypes.SHIPMENT_INVENTORY_LIST),
        ...
        edit: createThunkReducer(actionTypes.SHIPMENT_EDIT_AMOUNT)
    }),
    transaction: combineReducers({
        ...
        staffExpense: createThunkReducer(actionTypes.TRANSACTION_CATEGORY_DATA_LIST),
        detalization: createThunkReducer(actionTypes.TRANSACTION_DETALIZATION_LIST)
    }),
    ...
    statOutcomeCategory: combineReducers({
        ...
        detail: createThunkReducer(actionTypes.STAT_OUTCOME_CATEGORY_DETAIL),
    ...
    statExpenditureOnStaff: combineReducers({
        ...
        detail: createThunkReducer(actionTypes.STAT_EXPENDITURE_ON_STAFF_DETAIL),
    ...
    statReturn: combineReducers({
        ...
        sumDetails: createThunkReducer(actionTypes.STAT_RETURN_SUM_DETAILS)
    }),
